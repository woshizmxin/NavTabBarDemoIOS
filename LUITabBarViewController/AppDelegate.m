...
//    MMVC.tabBarItem = [[UITabBarItem alloc] initWithTabBarSystemItem:UITabBarSystemItemBookmarks tag:1];
    ...
    LLNav.title = @"LL";
    LLNav.tabBarItem.image=[UIImage imageNamed:@"tab_location.png"];//默认图片

    
    UINavigationController *MMNav = [[UINavigationController alloc] initWithRootViewController:MMVC];
    MMNav.title = @"MM";
    LLNav.tabBarItem.image=[UIImage imageNamed:@"tab_mine.png"];//默认图片
    ...
    for (UIViewController *controller in tabbarVC.viewControllers) {
